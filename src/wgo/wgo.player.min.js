/* eslint-disable */
/*! MIT license, more info: wgo.waltheri.net */(function(h,v){var p=function(a){var g=new w(JSON.parse(JSON.stringify(a.getProperties()))),n;for(n in a.children)g.appendChild(p(a.children[n]));return g},q=function(a,g){var n;if(g[a]!==v)return g[a];for(var x in g.children)if(n=q(a,g.children[x]))return n;return!1},u=function(a,g){a.push(JSON.parse(JSON.stringify(g.getProperties())));if(1<g.children.length){for(var n=[],x=0;x<g.children.length;x++){var B=[];u(B,g.children[x]);n.push(B)}a.push(n)}else g.children.length&&u(a,g.children[0])},k=function(a,
g){for(var n,x=1;x<a.length;x++)if(a[x].constructor==Array)for(var B=0;B<a[x].length;B++)n=new w(a[x][B][0]),g.appendChild(n),k(a[x][B],n);else n=new w(a[x]),g.insertAfter(n),g=n},e=function(a){return"string"==typeof a?a.replace(/\\/g,"\\\\").replace(/]/g,"\\]"):a},c=function(a,g){return String.fromCharCode(97+a)+String.fromCharCode(97+g)},d=function(a,g,n){if(g.length){n.sgf+=a;for(var x in g)n.sgf+="["+g[x]+"]"}},l=function(a,g){if(a.move){var n="";a.move.pass||(n=c(a.move.x,a.move.y));g.sgf=a.move.c==
h.B?g.sgf+("B["+n+"]"):g.sgf+("W["+n+"]")}if(a.setup){n=[];var x=[],B=[];for(A in a.setup)a.setup[A].c==h.B?n.push(c(a.setup[A].x,a.setup[A].y)):a.setup[A].c==h.W?x.push(c(a.setup[A].x,a.setup[A].y)):B.push(c(a.setup[A].x,a.setup[A].y));d("AB",n,g);d("AW",x,g);d("AE",B,g)}if(a.markup){n={};for(A in a.markup)n[a.markup[A].type]=n[a.markup[A].type]||[],"LB"==a.markup[A].type?n.LB.push(c(a.markup[A].x,a.markup[A].y)+":"+e(a.markup[A].text)):n[a.markup[A].type].push(c(a.markup[A].x,a.markup[A].y));for(var y in n)d(y,
n[y],g)}var A=a.getProperties();for(y in A)"object"!=typeof A[y]&&(g.sgf="turn"==y?g.sgf+("PL["+(A[y]==h.B?"B":"W")+"]"):"comment"==y?g.sgf+("C["+e(A[y])+"]"):g.sgf+(y+"["+e(A[y])+"]"));if(1==a.children.length)g.sgf+="\n;",l(a.children[0],g);else if(1<a.children.length)for(y in a.children)A=a.children[y],n=g,n.sgf+="(\n;",l(A,n),n.sgf+="\n)"},b=function(){this.size=19;this.info={};this.root=new w;this.propertyCount=this.nodeCount=0};b.prototype={constructor:b,clone:function(){var a=new b;a.size=this.size;
a.info=JSON.parse(JSON.stringify(this.info));a.root=p(this.root);a.nodeCount=this.nodeCount;a.propertyCount=this.propertyCount;return a},hasComments:function(){return!!q("comment",this.root)}};b.fromSgf=function(a){return h.SGF.parse(a)};b.fromJGO=function(a){a="string"==typeof a?JSON.parse(a):a;var g=new b;g.info=JSON.parse(JSON.stringify(a.info));g.size=a.size;g.nodeCount=a.nodeCount;g.propertyCount=a.propertyCount;g.root=new w(a.game[0]);k(a.game,g.root);return g};b.prototype.toSgf=function(){var a=
{sgf:"(\n;"},g={},n;for(n in this.info)"black"==n?(this.info.black.name&&(g.PB=e(this.info.black.name)),this.info.black.rank&&(g.BR=e(this.info.black.rank)),this.info.black.team&&(g.BT=e(this.info.black.team))):"white"==n?(this.info.white.name&&(g.PW=e(this.info.white.name)),this.info.white.rank&&(g.WR=e(this.info.white.rank)),this.info.white.team&&(g.WT=e(this.info.white.team))):g[n]=e(this.info[n]);this.size&&(g.SZ=this.size);g.AP||(g.AP="WGo.js:2");g.FF||(g.FF="4");g.GM||(g.GM="1");g.CA||(g.CA=
"UTF-8");for(n in g)g[n]&&(a.sgf+=n+"["+g[n]+"]");l(this.root,a);a.sgf+=")";return a.sgf};b.prototype.toJGO=function(a){var g={};g.size=this.size;g.info=JSON.parse(JSON.stringify(this.info));g.nodeCount=this.nodeCount;g.propertyCount=this.propertyCount;g.game=[];u(g.game,this.root);return a?JSON.stringify(g):g};var m=function(a){if(a.name){var g=h.filterHTML(a.name);a.rank&&(g+=" ("+h.filterHTML(a.rank)+")");a.team&&(g+=", "+h.filterHTML(a.team))}else a.team&&(g=h.filterHTML(a.team)),a.rank&&(g+=
" ("+h.filterHTML(a.rank)+")");return g};b.infoFormatters={black:m,white:m,TM:function(a){if(0==a)return h.t("none");var g,n=Math.floor(a/3600);1==n?g="1 "+h.t("hour"):1<n&&(g=n+" "+h.t("hours"));n=Math.floor((a-3600*n)/60);1==n?g+=" 1 "+h.t("minute"):1<n&&(g+=" "+n+" "+h.t("minutes"));n=a%60;1==n?g+=" 1 "+h.t("second"):1<n&&(g+=" "+n+" "+h.t("seconds"));return g},RE:function(a){return'<a href="javascript: void(0)" onclick="this.parentNode.innerHTML = \''+h.filterHTML(a)+'\'" title="'+h.t("res-show-tip")+
'">'+h.t("show")+"</a>"}};b.infoList="black white AN CP DT EV GN GC HA ON OT RE RO RU SO TM US PC KM".split(" ");h.Kifu=b;var f=function(a,g,n){for(var x=0;x<a.length;x++)if(a[x].x==g.x&&a[x].y==g.y){a[x][n]=g[n];return}a.push(g)},r=function(a,g){if(a)for(var n=0;n<a.length;n++)if(a[n].x==g.x&&a[n].y==g.y){a.splice(n,1);break}},w=function(a,g){this.parent=g||null;this.children=[];if(a)for(var n in a)this[n]=a[n]};w.prototype={constructor:w,getChild:function(a){a=a||0;return this.children[a]?this.children[a]:
null},addSetup:function(a){this.setup=this.setup||[];f(this.setup,a,"c");return this},removeSetup:function(a){r(this.setup,a);return this},addMarkup:function(a){this.markup=this.markup||[];f(this.markup,a,"type");return this},removeMarkup:function(a){r(this.markup,a);return this},remove:function(){var a=this.parent;if(!a)throw new Exception("Root node cannot be removed");for(var g in a.children)if(a.children[g]==this){a.children.splice(g,1);break}a.children=a.children.concat(this.children);this.parent=
null;return a},insertAfter:function(a){for(var g in this.children)this.children[g].parent=a;a.children=a.children.concat(this.children);a.parent=this;this.children=[a];return a},appendChild:function(a){a.parent=this;this.children.push(a);return a},getProperties:function(){var a={},g;for(g in this)this.hasOwnProperty(g)&&"children"!=g&&"parent"!=g&&"_"!=g[0]&&(a[g]=this[g]);return a}};h.KNode=w;var z=function(a,g){for(var n=a.size,x=[],B=[],y=0;y<n*n;y++)a.schema[y]&&!g.schema[y]?B.push({x:Math.floor(y/
n),y:y%n}):a.schema[y]!=g.schema[y]&&x.push({x:Math.floor(y/n),y:y%n,c:g.schema[y]});return{add:x,remove:B}};m=function(a,g,n){this.kifu=a;this.node=this.kifu.root;this.allow_illegal=n||!1;this.game=new h.Game(this.kifu.size,this.allow_illegal?"NONE":"KO",this.allow_illegal,this.allow_illegal);this.path={m:0};this.kifu.info.HA&&1<this.kifu.info.HA&&(this.game.turn=h.W);this.change=E(this.game,this.node,!0);this.rememberPath=g?!0:!1};var C=function(a,g){var n=[],x;for(x in a){var B=!0;for(var y in g)if(a[x].x==
g[y].x&&a[x].y==g[y].y){B=!1;break}B&&n.push(a[x])}return n},E=function(a,g,n){g.parent&&(g.parent._last_selected=g.parent.children.indexOf(g));if(g.move!=v){if(g.move.pass)return a.pass(g.move.c),{add:[],remove:[]};a=a.play(g.move.x,g.move.y,g.move.c);if("number"==typeof a)throw new D(a,g);for(var x in a)if(a[x].x==g.move.x&&a[x].y==g.move.y)return{add:[],remove:a};return{add:[g.move],remove:a}}n||a.pushPosition();n=[];var B=[];if(g.setup!=v)for(x in g.setup)g.setup[x].c?(a.setStone(g.setup[x].x,
g.setup[x].y,g.setup[x].c),n.push(g.setup[x])):(a.removeStone(g.setup[x].x,g.setup[x].y),B.push(g.setup[x]));g.turn&&(a.turn=g.turn);return{add:n,remove:B}},F=function(a){a===v&&this.rememberPath&&(a=this.node._last_selected);a=a||0;var g=this.node.children[a];if(!g)return!1;var n=E(this.game,g);this.path.m++;1<this.node.children.length&&(this.path[this.path.m]=a);this.node=g;return n},G=function(){if(!this.node.parent)return!1;this.node=this.node.parent;this.game.popPosition();this.node.turn&&(this.game.turn=
this.node.turn);this.path[this.path.m]!==v&&delete this.path[this.path.m];this.path.m--;return!0},H=function(){this.game.firstPosition();this.node=this.kifu.root;this.path={m:0};this.kifu.info.HA&&1<this.kifu.info.HA&&(this.game.turn=h.W);this.change=E(this.game,this.node,!0)};m.prototype={constructor:m,next:function(a){this.change=F.call(this,a);return this},last:function(){var a;for(this.change={add:[],remove:[]};a=F.call(this);){var g=this.change;g.add=C(g.add,a.remove).concat(a.add);g.remove=
C(g.remove,a.add).concat(a.remove)}return this},previous:function(){var a=this.game.getPosition();G.call(this);this.change=z(a,this.game.getPosition());return this},first:function(){var a=this.game.getPosition();H.call(this);this.change=z(a,this.game.getPosition());return this},goTo:function(a){if(a===v)return this;var g=this.game.getPosition();H.call(this);for(var n=0;n<a.m&&F.call(this,a[n+1]);n++);this.change=z(g,this.game.getPosition());return this},previousFork:function(){for(var a=this.game.getPosition();G.call(this)&&
1==this.node.children.length;);this.change=z(a,this.game.getPosition());return this},getPosition:function(){return this.game.getPosition()},allowIllegalMoves:function(a){a?(this.game.allow_rewrite=!0,this.game.allow_suicide=!0,this.repeating="NONE"):(this.game.allow_rewrite=!1,this.game.allow_suicide=!1,this.repeating="KO")}};h.KifuReader=m;var D=function(a,g){this.name="InvalidMoveError";this.message="Invalid move in kifu detected. ";if(g.move&&g.move.c!==v&&g.move.x!==v&&g.move.y!==v){var n=g.move.x;
7<g.move.x&&n++;String.fromCharCode(n+65);this.message+="Trying to play "+(g.move.c==h.WHITE?"white":"black")+" move on "+String.fromCharCode(g.move.x+65)+(19-g.move.y)}else this.message+="Move object doesn't contain arbitrary attributes.";if(a)switch(a){case 1:this.message+=", but these coordinates are not on board.";break;case 2:this.message+=", but there already is a stone.";break;case 3:this.message+=", but this move is a suicide.";break;case 4:this.message+=", but this position already occured."}else this.message+=
"."};D.prototype=Error();D.prototype.constructor=D;h.InvalidMoveError=D;h.i18n.en.show="show";h.i18n.en["res-show-tip"]="Click to show result."})(WGo);(function(h,v){h.SGF={};v=function(c,d,l,b,m,f){d=f==d?"black":"white";l.info[d]=l.info[d]||{};l.info[d][c]=m[0]};var p=h.SGF.properties={};p.B=p.W=function(c,d,l,b){d.move=!l[0]||19>=c.size&&"tt"==l[0]?{pass:!0,c:"B"==b?h.B:h.W}:{x:l[0].charCodeAt(0)-97,y:l[0].charCodeAt(1)-97,c:"B"==b?h.B:h.W}};p.AB=p.AW=function(c,d,l,b){for(var m in l)d.addSetup({x:l[m].charCodeAt(0)-97,y:l[m].charCodeAt(1)-97,c:"AB"==b?h.B:h.W})};p.AE=function(c,d,l){for(var b in l)d.addSetup({x:l[b].charCodeAt(0)-97,y:l[b].charCodeAt(1)-
97})};p.PL=function(c,d,l){d.turn="b"==l[0]||"B"==l[0]?h.B:h.W};p.C=function(c,d,l){d.comment=l.join()};p.LB=function(c,d,l){for(var b in l)d.addMarkup({x:l[b].charCodeAt(0)-97,y:l[b].charCodeAt(1)-97,type:"LB",text:l[b].substr(3)})};p.CR=p.SQ=p.TR=p.SL=p.MA=function(c,d,l,b){for(var m in l)d.addMarkup({x:l[m].charCodeAt(0)-97,y:l[m].charCodeAt(1)-97,type:b})};p.SZ=function(c,d,l){c.size=parseInt(l[0])};p.BR=p.WR=v.bind(this,"rank","BR");p.PB=p.PW=v.bind(this,"name","PB");p.BT=p.WT=v.bind(this,"team",
...
loadJSON:function(f,r){try{this.loadKifu(h.Kifu.fromJGO(f),r)}catch(w){this.error(w)}},loadSgfFromFile:function(f,r){var w=this;try{p(f,function(z){w.loadSgf(z,r)})}catch(z){this.error(z)}},addEventListener:function(f,r){this.listeners[f]=this.listeners[f]||[];this.listeners[f].push(r)},removeEventListener:function(f,r){this.listeners[f]&&(r=this.listeners[f].indexOf(r),-1!=r&&this.listeners[f].splice(r,1))},dispatchEvent:function(f){if(this.listeners[f.type])for(var r in this.listeners[f.type])this.listeners[f.type][r](f)},
...
black:"Black",white:"White",DT:"Date",KM:"Komi",HA:"Handicap",AN:"Annotations",CP:"Copyright",GC:"Game comments",GN:"Game name",ON:"Fuseki",OT:"Overtime",TM:"Basic time",RE:"Result",RO:"Round",RU:"Rules",US:"Recorder",PC:"Place",EV:"Event",SO:"Source",none:"none",bpass:"Black passed.",wpass:"White passed."},m;for(m in b)h.i18n.en[m]=b[m]})(WGo);(function(h){var v=0,p=function(k,e,c){var d={};d.element=document.createElement("div");d.element.className="wgo-player-"+k;d.wrapper=document.createElement("div");d.wrapper.className="wgo-player-"+k+"-wrapper";d.element.appendChild(d.wrapper);e.appendChild(d.element);c||(d.element.style.display="none");return d},q=function(k){var e;if(e=this.currentLayout.layout?this.currentLayout.layout[k]:this.currentLayout[k]){this.regions[k].element.style.display="block";e.constructor!=Array&&(e=[e]);for(var c in e)this.components[e[c]]||
...
"";this.classes=(this.element.className?this.element.className+" ":"")+"wgo-player-main";this.element.className=this.classes;this.element.id||(this.element.id="wgo_"+v++);this.dom={};this.dom.center=document.createElement("div");this.dom.center.className="wgo-player-center";this.dom.board=document.createElement("div");this.dom.board.className="wgo-player-board";this.regions={};this.regions.left=p("left",this.element);this.element.appendChild(this.dom.center);this.regions.right=p("right",this.element);
this.regions.top=p("top",this.dom.center);this.dom.center.appendChild(this.dom.board);this.regions.bottom=p("bottom",this.dom.center);this.board=new h.Board(this.dom.board,this.config.board);this.init();this.components={};window.addEventListener("resize",function(){this.noresize||this.updateDimensions()}.bind(this));this.updateDimensions();this.initGame()});u.prototype.appendTo=function(k){k.appendChild(this.element);this.updateDimensions()};u.prototype.updateDimensions=function(){for(var k=window.getComputedStyle(this.element),
...
c.position.capCount.black);void 0!==c.position.capCount.white&&(this.white.info.caps.val.innerHTML=c.position.capCount.white)},k=WGo.extendClass(WGo.BasicPlayer.component.Component,function(c){this.super(c);this.element.className="wgo-infobox";h.call(this,"white");h.call(this,"black");this.element.appendChild(this.white.box);this.element.appendChild(this.black.box);c.addEventListener("kifuLoaded",p.bind(this));c.addEventListener("update",u.bind(this))});k.prototype.setPlayerTime=function(c,d){var l=
Math.round(d)%60;this[c].info.time.val.innerHTML=Math.floor(d/60)+":"+(10>l?"0"+l:l)};k.prototype.updateDimensions=function(){q(this.black.name);q(this.white.name)};var e=WGo.BasicPlayer.layouts;e.right_top.right.push("InfoBox");e.right.right.push("InfoBox");e.one_column.top.push("InfoBox");e.no_comment.top.push("InfoBox");WGo.i18n.en.rank="Rank";WGo.i18n.en.caps="Caps";WGo.i18n.en.time="Time";WGo.BasicPlayer.component.InfoBox=k})(WGo);(function(h,v){var p=function(e){var c=e.charCodeAt(0)-97;0>c&&(c+=32);7<c&&c--;var d=e.charCodeAt(1)-48;2<e.length&&(d=10*d+(e.charCodeAt(2)-48));d=this.kifuReader.game.size-d;this._tmp_mark={type:"MA",x:c,y:d};this.board.addObject(this._tmp_mark)},q=function(){this.board.removeObject(this._tmp_mark);delete this._tmp_mark},u=function(e,c){for(var d in e)e[d].className&&"wgo-move-link"==e[d].className?(e[d].addEventListener("mouseover",p.bind(c,e[d].innerHTML)),e[d].addEventListener("mouseout",q.bind(c))):
...
function(e){"false"==e.toLowerCase()&&(this.formatNicks=!1)};h.BasicPlayer.attributes["data-wgo-formatmoves"]=function(e){"false"==e.toLowerCase()&&(this.formatMoves=!1)};h.BasicPlayer.layouts.right_top.right.push("CommentBox");h.BasicPlayer.layouts.right.right.push("CommentBox");h.BasicPlayer.layouts.one_column.bottom.push("CommentBox");h.i18n.en.comments="Comments";h.i18n.en.gameinfo="Game info";h.BasicPlayer.component.CommentBox=v})(WGo);(function(h,v){var p=h.extendClass(h.BasicPlayer.component.Component,function(b){this.super(b);this.widgets=[];this.element.className="wgo-player-control";this.iconBar=document.createElement("div");this.iconBar.className="wgo-control-wrapper";this.element.appendChild(this.iconBar);var m;for(m in p.widgets){var f=new p.widgets[m].constructor(b,p.widgets[m].args);f.appendTo(this.iconBar);this.widgets.push(f)}});p.prototype.updateDimensions=function(){this.element.className=340>this.element.clientWidth?
...
this.element.parentElement.appendChild(b.menu),p.menu){var m=new p.menu[f].constructor(b,p.menu[f].args,!0);m.appendTo(b.menu)}if("none"!=b.menu.style.display)return b.menu.style.display="none",document.removeEventListener("click",b._menu_ev),delete b._menu_ev,this.unselect(),!1;b.menu.style.display="block";m=this.element.offsetTop;var f=this.element.offsetLeft;this.element.parentElement.parentElement.parentElement.parentElement==b.regions.bottom.wrapper?(b.menu.style.left=f+"px",b.menu.style.top=
m-b.menu.offsetHeight+1+"px"):(b.menu.style.left=f+"px",b.menu.style.top=m+this.element.offsetHeight+"px");b._menu_ev=d.bind(this,b);b._menu_tmp=!0;document.addEventListener("click",b._menu_ev);return!0}};p.menu=[{constructor:q.MenuItem,args:{name:"switch-coo",togglable:!0,click:function(b){b.setCoordinates(!b.coordinates);return b.coordinates},init:function(b){b.coordinates&&this.select()}}}];p.widgets=[{constructor:q.Group,args:{name:"left",widgets:[{constructor:q.Button,args:{name:"menu",togglable:!0,
...
multinext:"10 moves forward",last:"Last","switch-coo":"Display coordinates",menu:"Menu"};for(var l in v)h.i18n.en[l]=v[l];h.BasicPlayer.component.Control=p})(WGo);(function(h){var v=function(q,u){this.player.frozen||this._lastX==q&&this._lastY==u||(this._lastX=q,this._lastY=u,this._last_mark&&this.board.removeObject(this._last_mark),-1!=q&&-1!=u&&this.player.kifuReader.game.isValid(q,u)?(this._last_mark={type:"outline",x:q,y:u,c:this.player.kifuReader.game.turn},this.board.addObject(this._last_mark)):delete this._last_mark)},p=function(){this._last_mark&&(this.board.removeObject(this._last_mark),delete this._last_mark,delete this._lastX,delete this._lastY)};
...
function(k){(u._disabled=u.disabled)||u.disable()});q.addEventListener("unfrozen",function(k){u._disabled||u.enable();delete u._disabled})}}});h.i18n.en.editmode="Edit mode"})(WGo);(function(h){var v=function(k,e,c,d){this.originalPosition=k;this.position=k.clone();this.board=e;this.komi=c;this.output=d},p=v.state={UNKNOWN:0,BLACK_STONE:1,WHITE_STONE:-1,BLACK_CANDIDATE:2,WHITE_CANDIDATE:-2,BLACK_NEUTRAL:3,WHITE_NEUTRAL:-3,NEUTRAL:4},q=function(k,e,c,d,l){var b=k.get(e,c);void 0!==b&&b!=d&&b!=l&&(k.set(e,c,d),q(k,e-1,c,d,l),q(k,e,c-1,d,l),q(k,e+1,c,d,l),q(k,e,c+1,d,l))},u=function(k,e,c,d,l){var b=e.get(c,d);k.get(c,d)!=b&&(k.set(c,d,b),u(k,e,c-1,d,l),u(k,e,c,d-1,l),u(k,e,c+
1,d,l),u(k,e,c,d+1,l))};v.prototype.start=function(){this.calculate();this.saved_state=this.board.getState();this.displayScore();this._click=function(k,e){var c=this.originalPosition.get(k,e);c==h.W?this.position.get(k,e)==p.WHITE_STONE?q(this.position,k,e,p.BLACK_CANDIDATE,p.BLACK_STONE):(u(this.position,this.originalPosition,k,e,p.BLACK_STONE),this.calculate()):c==h.B?this.position.get(k,e)==p.BLACK_STONE?q(this.position,k,e,p.WHITE_CANDIDATE,p.WHITE_STONE):(u(this.position,this.originalPosition,
k,e,p.WHITE_STONE),this.calculate()):(c=this.position.get(k,e),c==p.BLACK_CANDIDATE?this.position.set(k,e,p.BLACK_NEUTRAL):c==p.WHITE_CANDIDATE?this.position.set(k,e,p.WHITE_NEUTRAL):c==p.BLACK_NEUTRAL?this.position.set(k,e,p.BLACK_CANDIDATE):c==p.WHITE_NEUTRAL&&this.position.set(k,e,p.WHITE_CANDIDATE));this.board.restoreState({objects:h.clone(this.saved_state.objects)});this.displayScore()}.bind(this);this.board.addEventListener("click",this._click)};v.prototype.end=function(){this.board.restoreState({objects:h.clone(this.saved_state.objects)});
this.board.removeEventListener("click",this._click)};v.prototype.displayScore=function(){for(var k=[],e=[],c=[],d=[],l=[],b=0;b<this.position.size;b++)for(var m=0;m<this.position.size;m++)s=this.position.get(b,m),t=this.originalPosition.get(b,m),s==p.BLACK_CANDIDATE?k.push({x:b,y:m,type:"mini",c:h.B}):s==p.WHITE_CANDIDATE?e.push({x:b,y:m,type:"mini",c:h.W}):s==p.NEUTRAL&&c.push({x:b,y:m}),t==h.W&&s!=p.WHITE_STONE?l.push({x:b,y:m,type:"outline",c:h.W}):t==h.B&&s!=p.BLACK_STONE&&d.push({x:b,y:m,type:"outline",
...
" = "+b+"</br>";c+=h.t("white")+": "+e.length+" + "+(d.length+this.originalPosition.capCount.white)+" + "+this.komi+" = "+m+"</p>";c=b>m?c+("<p style='font-weight: bold;'>"+h.t("bwin",b-m)+"</p>"):c+("<p style='font-weight: bold;'>"+h.t("wwin",m-b)+"</p>");this.output(c)};v.prototype.calculate=function(){var k,e;var c=this.position;for(e=!0;e;){e=!1;for(var d=0;d<c.size;d++)for(var l=0;l<c.size;l++){var b=c.get(l,d);if(b==p.UNKNOWN||b==p.BLACK_CANDIDATE||b==p.WHITE_CANDIDATE){var m=[c.get(l-1,d),
c.get(l,d-1),c.get(l+1,d),c.get(l,d+1)];var f=k=!1;for(var r=0;4>r;r++)m[r]==p.BLACK_STONE||m[r]==p.BLACK_CANDIDATE?k=!0:m[r]==p.WHITE_STONE||m[r]==p.WHITE_CANDIDATE?f=!0:m[r]==p.NEUTRAL&&(f=k=!0);m=!1;k&&f?m=p.NEUTRAL:k?m=p.BLACK_CANDIDATE:f&&(m=p.WHITE_CANDIDATE);m&&b!=m&&(e=!0,c.set(l,d,m))}}}};h.ScoreMode=v;h.BasicPlayer&&h.BasicPlayer.component.Control&&h.BasicPlayer.component.Control.menu.push({constructor:h.BasicPlayer.control.MenuItem,args:{name:"scoremode",togglable:!0,click:function(k){if(this.selected)return k.setFrozen(!1),
this._score_mode.end(),delete this._score_mode,k.notification(),k.help(),!1;k.setFrozen(!0);k.help("<p>"+h.t("help_score")+"</p>");this._score_mode=new h.ScoreMode(k.kifuReader.game.position,k.board,k.kifu.info.KM||.5,k.notification);this._score_mode.start();return!0}}});h.i18n.en.scoremode="Count score";h.i18n.en.score="Score";h.i18n.en.bwin="Black wins by $ points.";h.i18n.en.wwin="White wins by $ points.";h.i18n.en.help_score="Click on stones to mark them dead or alive. You can also set and unset territory points by clicking on them. Territories must be completely bordered."})(WGo);(function(h,v){var p={active:!0,query:{}},q=function(k){try{p.query=JSON.parse('{"'+window.location.hash.substr(1).replace("=",'":')+"}")}catch(e){p.query={}}};window.addEventListener("hashchange",function(){if(""!=window.location.hash&&p.active){q();for(var k in p.query){var e=document.getElementById(k);e&&e._wgo_player&&e._wgo_player.goTo(u)}}});window.addEventListener("DOMContentLoaded",function(){""!=window.location.hash&&p.active&&q()});window.addEventListener("load",function(){if(""!=window.location.hash&&
p.active)for(var k in p.query){var e=document.getElementById(k);if(e&&e._wgo_player){e.scrollIntoView();break}}});var u=function(){if(p.query[this.element.id])return p.query[this.element.id].goto};h.Player.default.move=u;h.BasicPlayer&&h.BasicPlayer.component.Control&&h.BasicPlayer.component.Control.menu.push({constructor:h.BasicPlayer.control.MenuItem,args:{name:"permalink",click:function(k){var e=location.href.split("#")[0]+"#"+k.element.id+'={"goto":'+JSON.stringify(k.kifuReader.path)+"}";k.showMessage("<h1>"+
h.t("permalink")+'</h1><p><input class="wgo-permalink" type="text" value=\''+e+'\' onclick="this.select(); event.stopPropagation()"/></p>')}}});h.Player.permalink=p;h.i18n.en.permalink="Permanent link"})(WGo);
